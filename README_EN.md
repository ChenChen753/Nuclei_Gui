...
- Windows: upload `Nuclei_GUI*.exe`, for example `Nuclei_GUI_v2.5.4.exe` or `Nuclei_GUI_windows_x64_v2.5.4.exe`. Binary update support is currently limited to the Windows exe build.
